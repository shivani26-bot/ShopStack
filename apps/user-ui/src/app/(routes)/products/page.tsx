...
const Page = () => {
  ...
  console.log("selcol", selectedColors);
  return (
...
// So pressing the Back button will return to the previous URL.

// router.replace(url)
// Navigates to the new page.
// Replaces the current entry in browser history.
// So pressing Back will skip over that navigation.

// router.push("/products?page=2");
// Browser history stack:
// [ "/products?page=1", "/products?page=2" ]
// If the user clicks Back → goes to /products?page=1.

// router.replace("/products?page=2");
// Browser history stack:
// [ "/products?page=2" ] (the old entry is replaced).
// If the user clicks Back → won’t go to /products?page=1, it’ll go further back.
